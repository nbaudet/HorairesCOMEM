...
public class VectorClasse extends Vector<Classe> implements KvmSerializable {
    
    
    public VectorClasse(){}
    
    public VectorClasse(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
